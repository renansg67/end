...
col3.image("./figuras/biologist_taking_wood_core.jpg")
...
col1.image("./figuras/Infrared_thermal_imaging_during_a_yacht_survey.jpg", caption="FLIR E50 - Câmera Termográfica (CC BY-SA 4.0)")
